...
botClient.on('ready',() =>{
    ...
    console.log('OSSo is ready!' + " version " + version);
    ...
    const morning = new cron.CronJob('0 30 4 * * 1-5', () => {
        ...
        const morningEmbed = new Discord.MessageEmbed()
            .setColor('#31a5af')
            .setTitle('Good Day Deputies! Have a wonderful day ahead :)')
            .setTimestamp()
    ...
    const job = new cron.CronJob('0 0 12 * * 1,3,5', () => {
        ...
        const embed = new Discord.MessageEmbed()
            ...
            .setAuthor("From: ")
            .setDescription('1. No meeting this week!')
            .setTimestamp()
    ...
    botClient.on("guildMemberAdd", member => {
        member.send("Welcome to the SSD discord server! Type in .help to any channel in the server to get started!")
            .catch(console.error);
    });
            ...
            switch (args[0]){
                ...
                case 'help':
                    ...
                    .setColor("#31a5af")
                        .setTitle('GENERAL')
                        .addFields(
                            { name: '.announcements', value: 'sends the current announcements of SSDs' },
              ...
              case 'basics':
                ...
                case 'faqs':
                    ...
                    const help2 = new Discord.MessageEmbed()
                        ...
                        .setTitle('FAQS')
                        .addFields(
                            { name: 'How do I ask for an IC?', value: 'Feel free to message any executive directly!' },
                            ...
                            { name: 'How do I interact with OSSo?', value: 'Type in .help to check what he can do :)' },
                        )
                        .setTimestamp();
                ...
                case 'info':
                    ...
                    message.channel.send("Hi! I'm OSSo from the OSS, version 1.0! Nice to meet you, Deputy " + member4  + "\nType .help to get started.");
